export const resumeData = {
  profile: {
    ...
    title: "Développeur Web & Data Analyst / Administrateur Réseau",
    summary: "Développeur web et Data Analyst en devenir, avec un solide background en systèmes et réseaux. Passionné par la création de solutions logicielles et l'analyse de données. Allie logique, créativité et polyvalence technique (Dev, Data, Infra).",
  },
  contact: {
    email: "said.arikama-chabi@epitech.eu",
    phone: "0195472555 / 0167644707",
    location: "Bénin",
...
Dans cet univers, chaque dataset est une histoire à décoder.`,
  ...
  experiences: {
    network: [
      ...
      },
      {
        ...
        company: "PADME Bénin",
        period: "2021",
        description: "Assistance utilisateurs, Maintenance informatique, Configuration Cisco.",
      },
    ],
    web: [
      {
  ...
  education: {
    network: [
      {
        degree: "Master Systèmes Informatiques & Réseaux",
        school: "IFRI UAC",
        year: "2023 – 2025",
      },
      {
        degree: "Licence Réseaux Informatiques & Télécoms",
        school: "ESGIS Bénin",
        year: "2020",
      },
      {
  ...
  projects: {
    ...
    data: [
      ...
      },
      {
        ...
        description: "Analyse de texte TF-IDF, LSA et similarité cosinus.",
        tech: ["Scikit-learn", "NLP", "Python"],
      },
      {
        title: "Big Data & BI",
        description: "Analyse d'un dataset de 3M lignes et KPIs Power BI.",
        tech: ["Power BI", "Pandas", "Big Data"],
      },
    ],
  },
  skills: {
